...
public class CohortSingleAnalysisRemainHeatmapRepositoryImpl implements CohortSingleAnalysisRemainHeatmapRepository {

    @Override
    public CohortSingleAnalysisRemainHeatmapResponseDto requestSingleAnalysisChart(String clusterType) {
        try {
            // ✅ 파일 로드 시도
